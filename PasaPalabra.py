...
def juegoPasaPalabra():
    ...
    while entrada == "0":
        abecedario = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t",
                      "u", "v", "w", "y", "z"]
        # Número aleatorio para sacar una letra de la lista abecedario
        posicion_letra = random.randrange(0, 1)
        ...
        if letra == "a":
            ...
            if respuesta == respuesta_a:
                ...
                # SE LLAMA A LA FUNCION QUE VERIFICA SI SIGUE O NO EL JUEGO
